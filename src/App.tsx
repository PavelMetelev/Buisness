...
const RULES_DATA: Section[] = [
  ...
  },
  {
    ...
    rules: [
      {
        id: '3.2',
        text: 'Использование/Хранение сторонних ПО: (Читов/Макросов/Модов, дающих преимущество в игре)',
        punishment: 'бан на 7 дней',
        note: 'Хранение, удаление менее 7-ми дней назад, использование запрещённых программ.'
      },
      {
        id: '3.3',
        text: 'Тим с читером',
      ...
      {
        id: '3.10',
        text: 'Варп в трапе / бахалке',
        punishment: 'бан на 3 дня',
        note: 'Варп НЕЛЬЗЯ ставить в трапе (если не возможно выбраться хорусом или ендер-жемчугом) / бахалке и менее 10 блоков от нее.'
      },
      {
        id: '3.11',
        text: 'Постройка/использование/распространение уязвимостей сервера, независимо от их реализуемости и практичности.',
        punishment: 'бан на 15 дней',
        note: 'Постройки данного типа считаются некорректными и требуют сноса.'
      },
      {
        id: '3.12',
        text: 'Помеха в god / fly / v.',
        punishment: 'бан на 2 дня',
        note: 'Запрещено мешать ставить блоки, мешать в процессе пвп, давать/продлевать КТ.'
      },
      {
        id: '3.13',
    ...
    rules: [
      {
        ...
        punishment: 'бан на 7 дней',
        note: 'Доказательство на каждое выданное Вами наказание должно быть прикреплено в специальном разделе сообщества AvelX» в течение 1 часа.'
      },
      {
        id: '4.3',
      ...
      },
      {
        ...
        punishment: 'бан на 7 дней',
        note: 'Игроки с донатом D.ADMIN НЕ ИМЕЮТ ПРАВА телепортироваться к игрокам и убивать их.'
      },
    ]
  },
  {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 selection:bg-indigo-500/30 selection:text-indigo-200 font-sans">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-20">
        ...
        <header className="text-center mb-24">
          ...
          >
            AvelX <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500">Анархия</span>
          </motion.h1>
        ...
        <footer className="mt-32 pt-12 border-t border-slate-800 text-center text-slate-500 text-sm">
          ...
          <p>© {new Date().getFullYear()} AvelX - Minecraft Anarchy Server. Все права защищены.</p>
        </footer>
      </div>
